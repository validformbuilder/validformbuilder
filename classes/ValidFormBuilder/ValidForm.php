...
class ValidForm extends ClassDynamic
{
     ...
     * @return string Generated HTML
     */
    public function areaAsHtml($objField, $hideEmpty = false, $intDynamicCount = 0)
    {
        $strReturn = "";
        $strSet = "";
     ...
     * @return string Generated HTML
     */
    public function multiFieldAsHtml($objField, $hideEmpty = false, $intDynamicCount = 0)
    {
        $strReturn = "";
     ...
     * @return string Generated HTML
     */
    public function fieldAsHtml($objField, $hideEmpty = false, $intDynamicCount = 0)
    {
        $strReturn = "";
